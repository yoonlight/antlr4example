...
import com.khubla.antlr4example.asp.Visitors.FunctionVisitor;
...
public class FeatureExtractor {
    ...
    public ArrayList<ProgramFeatures> extractFeatures(String code) throws IOException {
        StartRuleContext context = parseFileWithRetries(code);
    ...
    public StartRuleContext parseFileWithRetries(String code) throws IOException {
        Lexer lexer = new VisualBasic6Lexer(CharStreams.fromString(code));
